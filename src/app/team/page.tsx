...
import pic from "../media.png"
import pic2 from "../desktop-hero-picture-1.png"
import pic3 from "../media (1).png"
...
<div className="bg-white p-10font-[sans-serif]">
  <div className="max-w-xl mx-auto text-center">
    <p>WHAT WE DO</p>
    <h2 className="text-gray-800 text-4xl font-extrabold relative after:absolute after:-bottom-5 after:h-1 after:w-1/2 after:left-0 after:right-0 after:mx-auto after:rounded-full">
    ...
    <div className="flex max-sm:flex-col justify-center gap-6 mt-12">
      <p
        ...
        className="min-w-[140px] rounded px-4 py-2.5 text-sm tracking-wider font-semibold outline-none  text-black  bg-white "
      >
        Home -- Team
      </p>
...
<div className="m-2">
  <Image className="img1" src={pic2} height={530} width={1440} alt="aa"/>
</div>
